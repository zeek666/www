<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"C:\wamp\www\tp5\admin\index\view\index\index.html";i:1508339049;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo U('goods/product_list'); ?>" data-title="产品管理" href="/static/admin/javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
