...
'API
AddResUrl -1,"","<h3>主流站资源（由田鸡资源采集站提供数据接口,保持同步更新）</h3>"
AddResUrl 01,"http://zy.freesaas.net/inc/freesaas.php","【田鸡云盘（标识:freesaas）】<font color=""#FF0000"">稳定、快速、更新及时---推荐</font>"
Header
Select Case ac
	Case "list":getlist()
	Case "bind":bindType
...
Sub Main
%>
<table class="tb2" style="margin:20px 0;font-size: 16px;">
	<thead>
...
<table class="tb">
		<tbody>
    <tr>
		<td><div style="margin:20px; font-size:14px;">
			<h2 style="font-size:16px;">站长帮助</h2>
                <div style="line-height:2;">
                    1.影视资源与解析交流QQ群：559074703 <a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=d8a13a576c007edff7f66d72febc67f01d623df4bad89a100c38182f9567bd04"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="田鸡资源采集网站技术交流1群" title="田鸡资源采集网站技术交流1群"></a><br />
                    2.图片定期更改路径，采集后请把图片同步到本地，避免图片失效<br />
                    3.高速稳定VIP视频云解析 https://www.freesaas.net<br />
                    4.田鸡云资源免费调用接口: https://www.jingqutuan.com/jx.php?id=<span style="color:red" >采集到的视频网址</span>&nbsp;&nbsp;&nbsp;<br/>
                    5.田鸡云资源VIP调用接口: https://www.jingqutuan.com/jx.php?token=<span style="color:red" >注册获取到的API调用token</span>&id=<span style="color:red" >采集到的采集到的视频网址</span>&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration:none" href="https://www.freesaas.net/index.php?m=Home&c=reg&a=index" target="_blank"><strong><span style="color:green" >获取VIP调用token </span></strong></a>&nbsp;&nbsp;&nbsp;<br />
                    6.主流cms播放器整合:<a style="text-decoration:none" href="https://www.freesaas.net/down/田鸡maxcms整合包.rar" target="_blank"><strong><span style="color:red" >田鸡maxcms整合包下载 </span></strong></a><br />
                </div>
			</div>
			<div style="line-height:2;margin:20px; font-size:14px;">
                <h2 style="font-size:16px;">我们的优势</h2>
                <p style="margin-bottom: 20px;">
                    1.聚合优酷，IQYI,乐视，QQ视频，搜狐，百度云，天翼云等十多个在线视频资源，7x24爬虫动态更新，您无需单独对每个网站进行采集。</br>
                    2.传统采集播放来源你采集多少个网站，就会显示多少播放组，非常累赘，我们聚合成一个播放组。网站只显示一个播放来源。</br>
                    3.云识别，智能纠错，聚合采集没有重复资源，标题统一格式</br>
                    4.智能报错,自动修复,一旦不能播放，我们智能轮替其他可以播放的资源</br>
                    5.无需技术，一键整合主流视频CMS，</br>
                    6.原创云盘播技术，可以自传资源（到百度云，天翼云），我们解析出播放地址</br>
                    7.热门影片存储自有服务器，拥抱资源稳定</br>
                    8.自主设定播放源播放顺序</br>
                </p>
            </div>
		</td>
